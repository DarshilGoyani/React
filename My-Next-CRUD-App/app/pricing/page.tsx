        ...
        <main className="min-h-screen bg-[#0a0a0a] text-white selection:bg-emerald-500/30 font-sans pb-24">
            ...
            <section className="px-6 relative z-10">
                <div className="max-w-7xl mx-auto w-full">
                    ...
                    >
                        {/* 1. TESTIMONIAL CARD */}
                        <motion.div variants={itemVariants} className="bg-[#121212] rounded-[2.5rem] p-6 flex flex-col justify-between border border-white/5 shadow-2xl hover:border-emerald-500/30 transition-colors duration-500 group">
                            <div className="w-full h-64 bg-[#1a1a1a] rounded-3xl flex flex-col items-center justify-center relative overflow-hidden mb-8 border border-white/5">
                                ...
                                <div className="relative z-10 flex flex-col items-center gap-4 text-gray-400 font-bold text-xl group-hover:scale-105 transition-transform duration-500">
                                    <div className="p-4 bg-[#222] rounded-2xl border border-white/10 shadow-xl">
                                        <svg className="w-8 h-8 text-emerald-400" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" /></svg>
                                    </div>
                            ...
                            <div className="relative px-2 pb-4">
                                <Quote className="w-8 h-8 text-emerald-500/20 absolute -top-4 -left-2 rotate-180" />
                        ...
                        {/* 2. BASIC PLAN */}
                        <motion.div variants={itemVariants} className="bg-[#121212] rounded-[2.5rem] p-8 flex flex-col border border-white/5 shadow-2xl hover:border-emerald-500/30 transition-colors duration-500">
                            ...
                            <div className="bg-[#1a1a1a] rounded-3xl p-6 md:p-8 flex-grow border border-white/5">
                            ...
                            <div className="text-center mt-6">
                                <p className="text-xs font-semibold text-gray-500 mb-4">*Ready for Boost</p>
                                <button className="w-full bg-white/5 hover:bg-emerald-500/10 border border-white/10 hover:border-emerald-500/50 text-white hover:text-emerald-400 py-3 rounded-full flex items-center justify-center gap-3 transition-all duration-300 group">
                        ...
                        <motion.div variants={itemVariants} className="bg-gradient-to-b from-[#121212] to-emerald-900/10 rounded-[2.5rem] p-8 flex flex-col border border-emerald-500/20 shadow-[0_0_40px_rgba(16,185,129,0.05)] hover:border-emerald-500/50 transition-colors duration-500 relative overflow-hidden">
                            {/* Pro Badge */}
                            ...
                            <div className="bg-[#1a1a1a] rounded-3xl p-6 md:p-8 flex-grow border border-emerald-500/10">
                                <h4 className="text-xs font-bold text-emerald-400 uppercase tracking-widest mb-6">Included</h4>
                                <ul className="flex flex-col gap-4 text-sm text-gray-300 font-medium">
                            ...
                            <div className="text-center mt-6">
                                <p className="text-xs font-semibold text-gray-500 mb-4">*Ready to Scale</p>
                                <button className="w-full bg-emerald-500 hover:bg-emerald-400 text-[#0a0a0a] py-3 rounded-full flex items-center justify-center gap-3 transition-colors duration-300 group shadow-lg shadow-emerald-500/20">
