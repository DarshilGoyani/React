...
import { Search, PlusCircle, LayoutGrid, MapPin } from "lucide-react"; // Real Icons
        ...
        <div className="max-w-[1300px] mx-auto px-4 h-20 flex items-center gap-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link 
              ...
              className="bg-[#0c831f] text-white px-5 py-2.5 rounded-lg flex items-center gap-2 hover:bg-[#096a18] transition-all font-bold shadow-md"
            >
              <LayoutGrid size={18} />
